...
<head>
    ...
    @hasSection('title')
        <title>@yield('title') - {{ \App\Models\Setting::get('site_name', 'AppWareTech') }}</title>
    @else
        <title>{{ \App\Models\Setting::get('site_name', 'AppWareTech') }} - {{ \App\Models\Setting::get('site_tagline', 'Software Solutions') }}</title>
    @endif
    
    @yield('meta_tags')
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="@yield('meta_description', \App\Models\Setting::get('site_description', 'Professional software development company'))">
    <meta name="keywords" content="@yield('meta_keywords', 'web development, software, laravel, wordpress, flutter')">
    <meta name="author" content="AppWareTech">
    
    <!-- Open Graph Tags -->
    <meta property="og:title" content="@yield('og_title', \App\Models\Setting::get('site_name', 'AppWareTech'))">
    <meta property="og:description" content="@yield('og_description', \App\Models\Setting::get('site_description', ''))">
    <meta property="og:image" content="@yield('og_image', asset('appwaretech-logo.png'))">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:type" content="website">
    
    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="@yield('twitter_title', \App\Models\Setting::get('site_name', 'AppWareTech'))">
    <meta name="twitter:description" content="@yield('twitter_description', \App\Models\Setting::get('site_description', ''))">
    
    <!-- Favicon -->
    <link rel="icon" type="image/jpeg" href="{{ asset('appwaretech-logo3.jpeg') }}">
    ...
    <style>
        :root {
            --primary-color: {{ \App\Models\Setting::get('primary_color', '#6c5ce7') }};
            --primary-light: {{ \App\Models\Setting::get('primary_color', '#6c5ce7') }}33;
            --secondary-color: {{ \App\Models\Setting::get('secondary_color', '#a855f7') }};
            --accent-color: #00d2ff;
