    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                ...
                <p style="color: rgba(255,255,255,0.7);">{{ \App\Models\Setting::get('footer_description', 'Professional software development company delivering innovative solutions for your business growth.') }}</p>
                <div class="mt-3">
                    @if(\App\Models\Setting::get('facebook_url'))
                    <a href="{{ \App\Models\Setting::get('facebook_url') }}" class="text-white me-3" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    @endif
                    @if(\App\Models\Setting::get('twitter_url'))
                    <a href="{{ \App\Models\Setting::get('twitter_url') }}" class="text-white me-3" target="_blank"><i class="fab fa-twitter"></i></a>
                    @endif
                    @if(\App\Models\Setting::get('linkedin_url'))
                    <a href="{{ \App\Models\Setting::get('linkedin_url') }}" class="text-white me-3" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                    @endif
                    @if(\App\Models\Setting::get('instagram_url'))
                    <a href="{{ \App\Models\Setting::get('instagram_url') }}" class="text-white" target="_blank"><i class="fab fa-instagram"></i></a>
                    @endif
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2" style="color: rgba(255,255,255,0.7);">
                        <i class="fas fa-envelope me-2"></i>{{ \App\Models\Setting::get('email', 'info@appwaretech.com') }}
                    </li>
                    <li class="mb-2" style="color: rgba(255,255,255,0.7);">
                        <i class="fas fa-phone me-2"></i>{{ \App\Models\Setting::get('phone', '+92 300 1234567') }}
                    </li>
                    <li class="mb-2" style="color: rgba(255,255,255,0.7);">
                        <i class="fas fa-map-marker-alt me-2"></i>{{ \App\Models\Setting::get('address', 'Lahore, Pakistan') }}
                    </li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
