...
@section('meta_description', 'Get in touch with AppWareTech for your software development needs')

@section('content')
<div class="container py-5">
    <div class="row">
        <div class="col-12 text-center mb-5 mt-5" data-aos="fade-up">
            <h1 class="display-4 fw-bold">{{ $contactSettings['page_title'] }}</h1>
            <p class="lead" style="font-size: 1.3rem; color: #ffffff;">{{ $contactSettings['page_description'] }}</p>
        </div>
    </div>
    
    <div class="row">
        @if($contactSettings['show_info'] == '1')
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0" style="color: #ffffff; font-size: 1.05rem;">{{ $contactSettings['address'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0" style="color: #ffffff; font-size: 1.05rem;">{{ $contactSettings['phone'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0" style="color: #ffffff; font-size: 1.05rem;">{{ $contactSettings['email'] }}</p>
                            </div>
                        </div>
                    </div>
        ...
        @if($contactSettings['show_form'] == '1')
