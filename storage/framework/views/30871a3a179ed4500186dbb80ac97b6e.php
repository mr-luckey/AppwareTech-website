<div class="card border-0 shadow-sm">
    <div class="card-body">
        ...
        <form action="<?php echo e(route('admin.settings.profile.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="new_password" name="password">
...
</div><?php /**PATH D:\wordpress\htdocs\New folder\appwaretech\resources\views/admin/settings/profile.blade.php ENDPATH**/ ?>