    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h2 mb-0">Add Team Member</h1>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="role" name="role" value="<?php echo e(old('role')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <div class="form-text">Upload a professional photo (JPEG, PNG, GIF, max 2MB)</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wordpress\htdocs\New folder\appwaretech\resources\views/admin/team-members/create.blade.php ENDPATH**/ ?>