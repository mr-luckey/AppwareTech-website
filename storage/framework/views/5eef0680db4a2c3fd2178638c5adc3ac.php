    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="<?php echo e(url('/')); ?>" style="color: rgba(255,255,255,0.7); text-decoration: none;">Home</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('services.index')); ?>" style="color: rgba(255,255,255,0.7); text-decoration: none;">Services</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('jobs.index')); ?>" style="color: rgba(255,255,255,0.7); text-decoration: none;">Jobs</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('courses.index')); ?>" style="color: rgba(255,255,255,0.7); text-decoration: none;">Courses</a></li>
                </ul>
            </div>
        ...
        <div class="text-center">
            <p style="color: rgba(255,255,255,0.6); margin-bottom: 0;">
                &copy; <?php echo e(date('Y')); ?> <?php echo e(\App\Models\Setting::get('site_name', 'AppWareTech')); ?>. All rights reserved.
            </p>
        </div>
    </div>
</footer>
