<?php $__env->startSection('title', 'Our Courses - ' . \App\Models\Setting::get('site_name')); ?>
<?php $__env->startSection('meta_description', 'Professional courses to enhance your skills'); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <div class="card h-100 border-0 shadow-sm card-hover">
                <?php if($course->image): ?>
                <img src="<?php echo e(asset('storage/' . $course->image)); ?>" class="card-img-top" alt="<?php echo e($course->title); ?>" style="height: 220px; object-fit: cover;">
                <?php else: ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <h5 class="card-title h4"><?php echo e($course->title); ?></h5>
                        <span class="badge bg-primary"><?php echo e(ucfirst($course->level)); ?></span>
                    </div>
                    <p class="text-primary fw-bold h5 mb-2">$<?php echo e(number_format($course->price, 2)); ?></p>
                    <p class="text-muted mb-2"><i class="fas fa-clock me-1"></i><?php echo e($course->duration); ?></p>
                    <p class="card-text"><?php echo e(Str::limit($course->short_description ?? $course->description, 100)); ?></p>
                    <button class="btn btn-primary enroll-btn" data-course-slug="<?php echo e($course->slug); ?>" data-course-title="<?php echo e($course->title); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wordpress\htdocs\New folder\appwaretech\resources\views/frontend/courses/index.blade.php ENDPATH**/ ?>